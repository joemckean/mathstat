...
bday <- function(n = 0) { #Default value for number of people in a sample size is zero
    ...
    # Error Handling input value 'n'
    if (n > 365) { # 365 represents the number of days in a year
