...
## Overview
This vignette illustrates the applicability of the concepts and alogrithms covered in 8th edition of the text *Introduction to Mathematical Statics* by Hogg, McKean, and Craig (2018). The topics in which these functions apply to includes but are not limited to the following:
