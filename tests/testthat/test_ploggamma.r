...
test_that("input", {
	...
	expect_error(ploggamma(c(0, 11, 12), 1, 1),
				 "all elements in argument 1 must be greater than or equal to 1")
...
test_that("x=c(10,11,12), alpha=0.5, beta=0.25", {
	...
	expected <- c(0.90000000000000002, 0.90909090909090906, 0.91666666666666663)
