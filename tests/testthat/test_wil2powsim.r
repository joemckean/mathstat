...
# Test invalid inputs.
test_that("input", {
	expect_error(wil2powsim("n1", 30, 1000, 0.2, 10, c(-3, 3, 1), 0.25),
				 "argument 1 must be a number")
	expect_error(wil2powsim(30, "n2", 1000, 0.2, 10, c(-3, 3, 1), 0.25),
				 "argument 2 must be a number")
	expect_error(wil2powsim(30, 30, "nsims", 0.2, 10, c(-3, 3, 1), 0.25),
				 "argument 3 must be a number")
	expect_error(wil2powsim(30, 30, 1000, "eps", 10, c(-3, 3, 1), 0.25),
				 "argument 4 must be a number")
	expect_error(wil2powsim(30, 30, 1000, 0.2, "vc", c(-3, 3, 1), 0.25),
	...
	expect_error(wil2powsim(30, 30, 1000, 0.2, 10, Inf, 0.25),
				 "argument 6 cannot include an Inf or -Inf")
	...
	expect_error(wil2powsim(30, 30, 1000, 0.2, 10, NaN, 0.25),
	...
	# with length of argument 2 and arg 6 vector is added to it.
	# Thus to fit dimensionality arg 2 must be divisible by the length of arg 6.
	#expect_error(wil2powsim(30, 30, 1000, 0.2, 10, c(-3, 3), 0.25),
