# Test for psum function Returns: An error message if any tests fail
...
test_that("output", {
  expect_equal(psum(c(0.1, 0.1, 0.2, 0.3, 0.2, 0.1)), c(0.1, 0.2, 0.4, 0.7, 0.9, 1))
  expect_equal(length(psum(c(0.1, 0.1, 0.2, 0.3, 0.2, 0.1))), 6)
  expect_equal(is.numeric(psum(c(0.1, 0.1, 0.2, 0.3, 0.2, 0.1))), TRUE)
})
