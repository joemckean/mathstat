...
test_that("input", {
  expect_error(condsim1("x"),
	             " * argument 1 must be an integer")
  expect_error(condsim1(-4),
	             " * argument 1 must be positive")
  expect_error(condsim1(c(1,2,3,4)),
	             " * argument 1 cannot have length greater than 1")
  expect_error(condsim1(5.5),
	             " * argument 1 must be an integer")
