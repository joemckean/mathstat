...
test_that("output", {
  ...
  set.seed(1234)
  samp <- condsim1(3)
  expect_true(samp[1] >= 1.034005 - ep && samp[1] <= 1.034005 + 
    ep)
  expect_true(samp[2] >= 1.446392 - ep && samp[2] <= 1.446392 + 
    ep)
  expect_true(samp[3] >= 2.008851 - ep && samp[3] <= 2.008851 + 
    ep)
})
...
test_that("limits", {
  ...
  set.seed(12345)
  samp <- condsim1(1)
  expect_true(samp[1] >= 2.723746 - ep && samp[1] <= 2.723746 + 
    ep)
