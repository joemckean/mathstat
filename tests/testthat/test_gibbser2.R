...
test_that("output", {
    expect_equal(length(gibbser2(alpha = 10, m = 3000, n = 6000)), 4)
    expect_equal(mode(gibbser2(alpha = 10, m = 3000, n = 6000)$y1), "numeric")
    expect_equal(mode(gibbser2(alpha = 10, m = 3000, n = 6000)$y2), "numeric")
    expect_equal(mode(gibbser2(alpha = 10, m = 3000, n = 6000)$x1), "numeric")
    expect_equal(mode(gibbser2(alpha = 10, m = 3000, n = 6000)$x2), "numeric")

    expect_equal(length(gibbser2(alpha = 10, m = 3000, n = 6000)$y1),
                 3000)
    expect_equal(length(gibbser2(alpha = 10, m = 3000, n = 6000)$y2),
                 6000)
    expect_equal(length(gibbser2(alpha = 10, m = 3000, n = 6000)$x1),
                 3000)
    expect_equal(length(gibbser2(alpha = 10, m = 3000, n = 6000)$x2),
                 6000)
})
